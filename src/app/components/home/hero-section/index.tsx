    ...
    const socialIcon = [
        {
            ...
            href: "https://x.com/christenekidd",
            icon: "Twitter"
        },
        {
                    ...
                    <div className="border-x border-primary/10">
                        <div className="relative flex flex-col xs:flex-row items-center xs:items-start justify-center xs:justify-between max-w-3xl mx-auto gap-10 xs:gap-3 px-4 sm:px-7 pt-22 pb-8 sm:pb-12">
                            <div className="absolute top-0 transform -translate-y-1/2">
                                <Image src={"/images/hero-sec/user-img.png"} alt="user-img" width={145} height={145} className="border-4 border-white rounded-full object-cover w-[145px] h-[145px]" />
                                <span className="absolute bottom-2.5 right-5 w-4 h-4 bg-green-500 border-2 border-white rounded-full object-cover" />
                            </div>
                            <div className="flex flex-col gap-2 sm:gap-3 items-center text-center xs:items-start">
                                <h1>Christene Kidd</h1>
                                <p className="text-violet-700 font-normal">Marketing Manager & Web Developer</p>
                            ...
                            <div className="flex flex-col md:flex-row items-center gap-4">
                                ...
                                <Button asChild className="h-auto rounded-full p-0.5!">
                                    <Link
                                        href="mailto:christenekidd@gmail.com"
